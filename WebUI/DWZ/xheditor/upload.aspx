...
<script runat="server">
    /*
 * 注：本程序将HTML5上传与普通POST上传转换为byte类型统一处理
 * 
 */
...
protected void Page_Load(object sender, EventArgs e)
{
    ...
    string attachdir = "../../DWZ/xheditor/upload";     // 上传文件保存路径，结尾不要带/
    int dirtype = 1;                 // 1:按天存入目录 2:按月存入目录 3:按扩展名存目录  建议使用按天存
    int maxattachsize = 12097152;     // 最大上传大小，默认是12M
    string upext = "txt,rar,zip,jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid,doc,docx,ppt,xls,xlsx";    // 上传扩展名

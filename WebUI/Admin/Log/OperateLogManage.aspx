<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperateLogManage.aspx.cs" Inherits="WebUI.Admin.Log.LogManage" %>
<script src="../../JS/Help.js" type="text/javascript"></script>
<form id="pagerForm" method="post" action="Admin/Log/OperateLogManage.aspx">
...
<script type="text/javascript">
 ...
 <div class="page">
	...
	<form onsubmit="return navTabSearch(this);" action="Admin/Log/OperateLogManage.aspx" method="post">
        <div class="searchBar">
            关键字
     ...
     <div class="pageContent">
        <div class="panelBar">
            ...
            <% if(p[0].ToString() == "")
     {%>
                <li><a class="delete" href="#" onclick="navMenuTodo('../AJAX/Log/LogManage.ashx?method=OperateLogDelete','log_id','您确定要删除已勾选信息吗?')"><span>删除</span></a></li>
           ...
           <table class="table" layouth="133" width="100%" >
			<thead>
               ...
               <input id="chkAddAll" align="center" onclick="AllCheck('log_id','chkLog')" type="checkbox" name="chkLog" />
                        </th>
				<th style="width: 10%; text-align: center" class="asc">
                            序号
                        </th>
					<th style="width: 20%; text-align: center" orderField="log_content" >日志内容</th>
					<th style="width: 20%; text-align: center" orderField="write_time" >记录时间</th>
					<th style="width: 20%; text-align: center" orderField="log_type" >日志类型</th>
				</tr>
			</thead>
				<tbody>
	...
	<tr id="flag" target="sys_log" rel="<%# Eval("log_id") %>"> 
	  ...
	  <td style="text-align: center">
	    ...
	    <td align="center"><%# (Eval("log_type") == "1") ? "错误日志" : "操作日志"%></td>
	</tr>
	</ItemTemplate>
	<FooterTemplate>
